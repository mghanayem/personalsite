...
- [GCS uploads architecture](gcs-uploads-architecture.md) — uploads use Replit Object Storage (GCS sidecar); disk fallback for pre-migration files; migration script at scripts/migrate-uploads-to-gcs.mjs
